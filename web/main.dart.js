...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = document,
        ...
        emailInput = t2._as(t1.querySelector("#email")),
        passwordInput = t2._as(t1.querySelector("#password"));
      t2 = type$._ElementEventStreamImpl_MouseEvent;
      A._EventStreamSubscription$(type$.ButtonElement._as(t1.querySelector("#loginBtn")), "click", t2._eval$1("~(1)?")._as(new A.main_closure(emailInput, passwordInput, type$.ParagraphElement._as(t1.querySelector("#message")))), false, t2._precomputed1);
    },
    main_closure: function main_closure(t0, t1, t2) {
      this.emailInput = t0;
      this.passwordInput = t1;
      this.message = t2;
    },
  ...
  A.main_closure.prototype = {
    call$1($event) {
      ...
      if (password == null)
        password = "";
      t1 = email.length === 0 || password.length === 0;
      t2 = this.message;
      if (t1) {
        B.ParagraphElement_methods.set$text(t2, "Please fill all fields");
        t1 = t2.style;
        t1.color = "red";
      } else {
        B.ParagraphElement_methods.set$text(t2, "Login successful");
        t1 = t2.style;
        t1.color = "green";
      }
    },
  ...
  (function inheritance() {
    ...
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A._CssStyleDeclaration_JavaScriptObject_CssStyleDeclarationBase, A.DomException, A.Event]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.main_closure]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.ButtonElement, A.FormElement, A.InputElement, A.ParagraphElement, A.SelectElement]);
